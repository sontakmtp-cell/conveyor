...
# --- [BẮT ĐẦU NÂNG CẤP VISUALIZATION 3D] ---
@dataclass
class VisualizationData:
    ...
    material_flow: Dict[str, Any] = field(default_factory=dict)
    safety_features: Dict[str, Any] = field(default_factory=dict)
...
# Mở rộng CalculationResult để thêm visualization_data
@dataclass
...
# --- [KẾT THÚC NÂNG CẤP VISUALIZATION 3D] ---
